 ...
 */
//@Component
public class WebcamViewerExample4 extends JFrame implements Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener {

	private static final long serialVersionUID = 1L;
	final static Logger logger = Logger.getLogger(WebcamViewerExample4.class);
...
//	}
	...
	public WebcamViewerExample4() throws HeadlessException {
		super();
...
//	}
	...
	public void init(){
		...
		//picker.add(Webcam.getWebcams().get(1));
		...
		startButton.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent evt) {
		        ...
		        if(startFaceIdentification){
		        	webcam.addWebcamListener(new IpCameraListener(sdk, personMap, context));
...
//	
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new WebcamViewerExample4());
	}
