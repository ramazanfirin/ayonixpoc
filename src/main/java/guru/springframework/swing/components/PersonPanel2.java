...
public class PersonPanel2 extends JInternalFrame {
	
	final static Logger logger = Logger.getLogger(PersonPanel2.class);
	...
	public PersonPanel2(BufferedImage image, String name,Float score,String cameraName) {
		super();
		this.image = image;
		this.name = name;
		this.score = score;
